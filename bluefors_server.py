...
inserv._add('multi1', drivers.Keysight34461A, 'TCPIP0::192.168.1.109::INSTR')
inserv._add('multi2', drivers.Keysight34461A, 'TCPIP0::192.168.1.110::INSTR')
inserv._add('multi3', drivers.Keysight34461A, 'TCPIP0::192.168.1.111::INSTR')
inserv._add("source1", drivers.KeysightB2962A, "TCPIP0::192.168.1.112::INSTR")
inserv._add("source2", drivers.KeysightB2962A, "TCPIP0::192.168.1.113::INSTR")
# inserv._add('femtos')
# inserv._add('motor')
